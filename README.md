...
```bat
probe_db.exe ^
  --id osm       --file "D:\2025\veliz\EstacionTerrena3\build\Recursos\Cuba_OSM_CID3.sqlitedb" ^
  --id satelital --file "D:\2025\veliz\EstacionTerrena3\build\Recursos\Cuba_Satelital_CID3.sqlitedb" ^
...
## 5. Notas sobre lo que se corrigió
...
## 8. Resultados del sondeo de las BD reales (agosto 2026)
...
## 9. Fase 3 — Motor de teselas asíncrono
...
## 10. Validación de la Fase 3 contra las BD reales
...
## 11. Nota de portabilidad: Qt 5.14 y `QVariant`
...
## 12. Tres optimizaciones que solo aparecieron al medir sobre las BD reales
...
## 13. Portabilidad: `#pragma once` y rutas de inclusión
...
## 14. Medición sobre las BD reales, zoom 15 y 16
...
## 15. Cobertura solo sobre tierra: mar abierto
...
## 16. Refinamiento por calidad, no solo por huecos
...
## 17. Validación final de la Fase 3: los dos desenlaces del refinamiento
...
## 19. Tres fallos encontrados probando `demo.exe`
...
## 19. Correcciones tras probar la Fase 4 en Windows
...
## 20. Los marcadores de las herramientas caían por debajo del cursor
...
## 20. Desfase del cursor en las herramientas
...
## 20. La marca caía unos píxeles por debajo del clic
...
## 21. Fase 5 — Capa de datos vectoriales
...
## 22. Qué se puede ver de la Fase 5
